...
public class DisplayQuantity {
  ...
  public static final Set<DisplayQuantity> DEFAULT_ELECTRICITY_DISPLAY_QUANTITIES =
    Set.of(
      new DisplayQuantity(
        Quantity.ENERGY,
        CONSUMPTION,
  ...
  public static final Set<DisplayQuantity> DEFAULT_ROOM_SENSOR_DISPLAY_QUANTITIES =
    Set.of(
      new DisplayQuantity(
  ...
  public static final Set<DisplayQuantity> DEFAULT_WATER_DISPLAY_QUANTITIES = Set.of(
    new DisplayQuantity(
      Quantity.VOLUME,
  ...
  public static final Set<DisplayQuantity> DEFAULT_GAS_DISPLAY_QUANTITIES = Set.of(
    new DisplayQuantity(
      Quantity.VOLUME,
      DisplayMode.CONSUMPTION,
      CUBIC_METRES
  ...
  public static final Set<DisplayQuantity> DEFAULT_DISTRICT_DISPLAY_QUANTITIES = Set.of(
    new DisplayQuantity(
      Quantity.ENERGY,
      DisplayMode.CONSUMPTION,
      KILOWATT_HOURS
