...
/**
* Whether this measurement represents an accumulated value (true) or not (false). The absence of this value is equivalent to specify it with a value of false
*
*/
...
public String toString() {
    return new ToStringBuilder(this).append("timestamp", timestamp).append("accumulated", accumulated).append("value", value).append("unit", unit).append("quantity", quantity).toString();
}
