 ...
 * <p>
 * This schema describes the format of the type of message that constitutes the protocol from a metering value delivery system and the MVP system.
 *
 */
public class MeterMessage {
    ...
    /**
     * Describes the device type or medium that the meter for which this message was created handles (e.g temperature)
     * (Required)
     *
     */
    ...
    public String toString() {
        return new ToStringBuilder(this).append("messageType", messageType).append("gatewayId", gatewayId).append("meterId", meterId).append("organisationId", organisationId).append("medium", medium).append("sourceSystemId", sourceSystemId).append("values", values).toString();
    }
    ...
    public enum MessageType {
        ...
        private final static Map<String, MeterMessage.MessageType> CONSTANTS = new HashMap<String, MeterMessage.MessageType>();
