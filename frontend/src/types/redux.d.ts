// see redux-thunk override here: https://github.com/piotrwitek/react-redux-typescript-guide
 ...
 */
export type ThunkActionDispatch<T extends (...args: any[]) =>
  ThunkAction<any, any, any, any>> = (...args: Parameters<T>) => ReturnType<ReturnType<T>>;

export type ThunkMiddleware<S = {},
  A extends Action = AnyAction,
  E = undefined> = Middleware<ThunkDispatch<S, E, A>, S, ThunkDispatch<S, E, A>>;
