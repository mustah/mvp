...
export const gatewayRequest = createEmptyAction(GATEWAY_REQUEST);
export const gatewaySuccess = createPayloadAction(GATEWAY_SUCCESS);
export const gatewayFailure = createPayloadAction(GATEWAY_FAILURE);
