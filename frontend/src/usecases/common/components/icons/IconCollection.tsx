...
/* tslint:disable */
export const IconCollection: React.SFC<SvgIconProps> = (props) => (
  <SvgIcon viewBox="210 238 111 143" {...props} color={props.color || 'white'}>
    ...
    <path d="M235.2,348.6 L235.2,348.6 C232.6,348.6 230.5,346.294118 230.5,343.439216 L230.5,342.560784 C230.5,339.705882 232.6,337.4 235.2,337.4 L235.2,337.4 C237.8,337.4 239.9,339.705882 239.9,342.560784 L239.9,343.439216 C240,346.294118 237.9,348.6 235.2,348.6 Z" id="Shape" stroke="none" fillRule="evenodd"/>
    <path d="M254.8,348.6 C252.2,348.6 250.1,346.294118 250.1,343.439216 L250.1,342.560784 C250.1,339.705882 252.2,337.4 254.8,337.4 C257.4,337.4 259.5,339.705882 259.5,342.560784 L259.5,343.439216 C259.5,346.294118 257.4,348.6 254.8,348.6 Z" id="Shape" stroke="none" fillRule="evenodd"/>
  </SvgIcon>
);
/* tslint:enable */
