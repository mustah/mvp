...
import {BatchReferences, BatchReferencesCreate} from '../../usecases/administration/otc/pages/BatchReferencePages';
...
export const OtcPages = () => (
  <Switch>
    ...
    <Route exact={true} path={`${routes.otcDevicesModify}/:id`} component={DevicesAdd}/>
