...
/* tslint:disable */
export const IconDuck = (props: SvgIconProps) => (
  <SvgIcon viewBox="0 0 475.7 401.3" {...props} color={props.color || colors.white}>
    <path d="M124.3,346.6c28.3,17,64.1,25.1,100.3,25.1c54.5,0,109.9-18.4,142.2-52.4c33.8-35.6,35.5-80.1,4.8-125.5
    ...
    <path d="M277.2,84.5c0,7.6,6.2,13.8,13.8,13.8c7.6,0,13.8-6.2,13.8-13.8s-6.2-13.8-13.8-13.8
			C283.4,70.7,277.2,76.9,277.2,84.5z"/>
    <path d="M320.6,127c3.7,8,11,12.5,18.6,16.4c10.3,5.4,20.8,10.3,31.6,14.5c5.8,2.2,10.9,4.4,17.2,2.7
